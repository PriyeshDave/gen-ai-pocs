...
# insert the path to the sys. the path to be added is to Data Copilot folder
sys.path.insert(1, '../Data-Copilot/')
...
st.set_page_config(page_title="Data Copilot", page_icon="../Data-Copilot/assets/images/favicon.png", layout="wide", initial_sidebar_state='collapsed')
col_main_1, col_main_2, col_main_3 = st.columns([1,5,1])

with open("./UI/Use Case Descriptions/data_copilot.txt") as f:
    data_copilot_intro_text = f.read()
    data_copilot_intro_text = data_copilot_intro_text.strip()
    f.close()

with col_main_2:
    st.markdown("<h1 style='text-align: center; color: black;'> Data Copilot </h1>", unsafe_allow_html=True)
    st.markdown("<h2 style='text-align: center; color: black;'> Your Conversational Bridge to Data Insights </h2>", unsafe_allow_html=True)
    st.markdown(f"<p style='text-align: center; color: black;'>{data_copilot_intro_text}</p>", unsafe_allow_html=True)
    st.markdown('##')
    data_copilot_demo_text = """
                            ...
                            """
    st.markdown(f"<p style='text-align: center; color: black;'>{data_copilot_demo_text}</p>", unsafe_allow_html=True)
...
with col_main_2:
    if not UPLOADED_FILE:
        UPLOADED_FILE = "../Data-Copilot/archive/views/sample_data_2.csv"
