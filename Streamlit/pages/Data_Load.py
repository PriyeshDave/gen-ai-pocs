...
st.set_page_config(page_title="Colleague On-Boarding Application", page_icon="../Colleague-OnBoarding/assets/images/favicon.png", layout="wide", initial_sidebar_state='collapsed')        
...
def show_data_bank_file_upload(data_bank_folder="../Colleague-OnBoarding/data-bank"):
...
def save_uploaded_file(file, user_name,default_img='../Colleague-OnBoarding/img/user_img.png'):
    if file:
        upload_folder = "img"
...
def save_to_json(data):
    user_data_dir = "../Colleague-OnBoarding/user-data"
