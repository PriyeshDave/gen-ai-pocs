...
import sys
sys.path.append('../Colleague-OnBoarding')
import gpt3 as open_ai_gpt3
import re
import os
...
directory_path = "../Colleague-OnBoarding/data-bank"
...
user_data = load_data_from_json('../Colleague-OnBoarding/user-data')
...
vectordb_path = '../Colleague-OnBoarding/vector_db/faiss_index'
